...
#include <softdevice/s140/headers/ble_gap.h>
#include "common.h"
#include "ble.h"
...
const BADGE_INFO badgeInfo[NUM_BADGE_GROUPS - 1] = {
        { badge_andnxor,        0x049E, "and!xor",          "@ANDnXOR"          },
        { badge_cpv,            0x0C97, "CPV",              "@CryptoVillage"    },
        { badge_darknet,        0x444E, "dcdarknet",        "@DCDarknet"        },
        { badge_dc801,          0x0801, "DC801",            "@dc801"            },
        { badge_dczia,          0x5050, "DCZIA",            "@DCZia505"         },
        { badge_FoB,            0x0069, "FoB",              "@B1un7"            },
        { badge_diana,          0x1010, "Diana Init",       "@B1un7"            },
        { badge_dc503,          0x0503, "DC503",            "@r00tkillah"       },
        { badge_dcfurs1,        0x71FF, "DefconFurs",       "@DCFurs"           },
        { badge_dcfurs2,        0x0DCF, "DefconFurs",       "@DCFurs"           },
        { badge_blinky,         0x4242, "MrBlinkyBling",    "@MrBlinkyBling"    },
        { badge_phase4_monkey,  0x0B25, "Phase4 Monkey",    "@abraxas3d"        },
        { badge_phase4_ham,     0x064A, "Phase4 Iono",      "@abraxas3d"        },
        { badge_queercon,       0x04D3, "Queercon",         "@Queercon"         },
        { badge_shotbot,        0x5051, "Shotbot!",         "@jediguybob"       },
        { badge_pirates,        0x1337, "BadgePirates",     "@BadgePirates"     },
        { badge_hak4kidz,       0x02E5, "Hak4Kidz",         "@Hak4Kidz"         },
        { badge_dc858_619,      0x0698, "DC858/619",        "@ellwoodthewood"   }
};
 ...
 *
 */
static uint8_t m_dczia_beacon_info[8] =
{
        ...
        case BLE_GAP_EVT_ADV_REPORT:
            ...
            if (p_gap_evt->params.adv_report.data.len > 0) {
                ...
                if(parseAdvertisementData(data, p_gap_evt->params.adv_report.data.len, &adv)) {
                    ...
                    if (adv.appearance == badgeYear_25
                        || adv.appearance == badgeYear_26
                        || adv.appearance == badgeYear_27) {
                        // Yes
...
void ble_adv_init(void){
	...
	// Set the manufacturer data to be a DCZIA badge
	ble_advdata_manuf_data_t manuf_specific_data;
	manuf_specific_data.company_identifier = APP_COMPANY_IDENTIFIER_DCZIA;
	manuf_specific_data.data.p_data = (uint8_t *) m_dczia_beacon_info;
